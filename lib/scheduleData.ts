...
export const scheduleData: { [key: number]: ScheduleItem[] } = {
  1: [
    ...
    { time: '8.45 pm - 9.30pm', agenda: 'Kirtan by HG Nitai Priya prabhu', venue: 'Temple', type: 'kirtan' },
  ],
  2: [
    ...
    { time: '8.00 am', agenda: 'Srimad Bhagavatam (HH Jayapataka Swami Maharaj with Tamil translation)', venue: 'Multi-purpose Hall', type: 'session' },
    ...
    { time: '10.15 am', agenda: 'Tamil Session 1 - Preaching Begins at Home: Turning the Family into a Grihastha Āśrama (HG Jagat Sakshi prabhu)', venue: 'Multi-purpose Hall', type: 'session' },
    ...
    { time: '4.45 pm', agenda: 'Youth Yoga Session (HG Nitai Priya prabhu)', venue: 'Prasadam Hall', type: 'workshop' },
    { time: '4.45 pm', agenda: 'Bengali Session (HH Bhakti Prachar Parivrajak Swami)', venue: 'Temple Hall', type: 'workshop' },
    ...
    { time: '8.15 pm', agenda: 'Drama - Kuresha: Guru Bhakti Examplified', venue: 'Multi-purpose Hall', type: 'ceremony' },
  ...
  3: [
    ...
    { time: '11.15 am', agenda: 'Youth Session 3 - Bhakti That Connects: Reaching Your Generation (HG Devakinandan prabhu)', venue: 'Conference Hall', type: 'session' },
    ...
    { time: '12.30 pm', agenda: 'Youth Session 4 - Devotee Care as a Preaching Service (HG Maha Varaha prabhu)', venue: 'Conference Hall', type: 'session' },
    ...
    { time: '1.30 - 2.30 pm', agenda: 'Lunch', venue: '-', type: 'meal' },
    { time: '3.00 - 4.30 pm', agenda: 'Rest', venue: '-', type: 'break' },
    { time: '4.00 pm', agenda: 'Workshop 3 English Session - Quality Sadhana & Philosophy: Foundation of becoming Good Devotees (HH Bhakti Prachar Parivrajak Swami)', venue: 'Temple Hall', type: 'session' },
    { time: '4.00 pm', agenda: 'Workshop 4 Tamil Session - Training and Tools for Effective Outreach (HG Jagat Sakshi prabhu)', venue: 'Multi-purpose Hall', type: 'session' },
    { time: '4.00 pm', agenda: 'Youth Workshop - From Reels to Mission: Being a Devotee Online - Part 2 (HH Bhakti Vinoda Swami)', venue: 'Conference Hall', type: 'workshop' },
    { time: '4.00 pm', agenda: 'Chinese Devotees Session (HH BVV Narasimha Swami)', venue: 'Sri Bala Murugan Temple Hall', type: 'session' },
  ...
  4: [
    ...
    { time: '10.15 am', agenda: 'Auction of Limited Edition Spiritual Paraphernalia', venue: '-', type: 'ceremony' },
