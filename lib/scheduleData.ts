...
export const scheduleData: { [key: number]: ScheduleItem[] } = {
  ...
  3: [
    ...
    { time: '12.30 pm', agenda: 'Youth Session 5 - Devotee Care as a Preaching Service (HG Maha Varaha prabhu)', venue: 'Conference Hall', type: 'session' },
    ...
    { time: '9.30 pm', agenda: 'Kirtan by HG Pavan Nitai prabhu', venue: 'Multi-purpose Hall', type: 'kirtan' }
  ],
  4: [
    { time: '5.00 am', agenda: 'Mangala Arati', venue: 'Temple Hall', type: 'ceremony' },
    { time: '5.25 am', agenda: 'Tulasi Puja', venue: 'Temple Hall', type: 'ceremony' },
