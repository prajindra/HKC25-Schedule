...
export const scheduleData: { [key: number]: ScheduleItem[] } = {
  ...
  3: [
    ...
    { time: '11.15 am', agenda: 'Youth Session 4 - Bhakti That Connects: Reaching Your Generation (HG Devakinandan prabhu)', venue: 'Sri Bala Murugan Temple Hall', type: 'session' },
