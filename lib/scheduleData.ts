...
export const scheduleData: { [key: number]: ScheduleItem[] } = {
  ...
  2: [
    ...
    { time: '4.45 pm', agenda: 'Workshop 2 Tamil Session (HH Bhakti Vinoda Swami)', venue: 'Multi-purpose Hall', type: 'workshop' },
    { time: '4.45 pm', agenda: 'Youth Yoga Session (HG Nitai Priya prabhu)', venue: 'Conference Hall', type: 'workshop' },
  ...
  3: [
    ...
    { time: '12.30 pm', agenda: 'Tamil Session 4 (Maha Varaha prabhu)', venue: 'Multi-purpose Hall', type: 'session' },
    ...
    { time: '4.00 pm', agenda: 'Youth Workshop (HH Bhakti Vinoda Swami)', venue: 'Conference Hall', type: 'workshop' },
    { time: '4.45 pm', agenda: 'Temple Presidents meeting (HG Yaduraj Prabhu)', venue: 'Nityananda Room', type: 'session' },
    { time: '6.00 - 7.00 pm', agenda: 'Dinner', venue: '-', type: 'meal' },
