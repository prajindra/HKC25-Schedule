...
export const scheduleData: { [key: number]: ScheduleItem[] } = {
  ...
  3: [
    ...
    { time: '1.30 - 2.30 pm', agenda: 'Lunch', venue: 'Prasadam Tent', type: 'meal' },
    { time: '3.00 - 4.30 pm', agenda: 'Rest', venue: '-', type: 'break' },
    { time: '3.00 pm - 4.30 pm', agenda: 'Temple Presidents Workshop (HG Yaduraj Prabhu)', venue: 'Sri Bala Murugan Temple Hall', type: 'session' },
    ...
    { time: '4.45 pm', agenda: 'Youth Workshop - From Reels to Mission: Being a Devotee Online - Part 2 (HH Bhakti Vinoda Swami)', venue: 'Conference Hall', type: 'workshop' },
    { time: '4.45 pm', agenda: 'Chinese Devotees Session (HH BVV Narasimha Swami)', venue: 'Sri Bala Murugan Temple Hall', type: 'session' },
  ...
  4: [
    ...
    { time: '12.30 pm', agenda: 'FINALE Kirtan by HG Nitai Priya prabhu', venue: 'Temple Hall', type: 'kirtan' },
